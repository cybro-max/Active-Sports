...
export const metadata: Metadata = {
  title: 'Global Football Leagues | ActiveSports',
      ...
      <section className="relative h-[350px] sm:h-[420px] rounded-[48px] overflow-hidden mb-16 fade-up group shadow-2xl border border-white/5">
         ...
         <div className="relative h-full flex flex-col items-center justify-center text-center px-6">
            ...
            <h1 className="text-6xl sm:text-8xl font-black text-white mb-6 tracking-tighter leading-none">
               WORLD <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">LEAGUES</span>
            </h1>
            ...
            <div className="absolute bottom-10 flex items-center gap-10 px-10 py-5 rounded-[28px] bg-white/[0.03] backdrop-blur-3xl border border-white/5 shadow-2xl">
               <div className="flex flex-col items-center">
                  ...
                  <span className="text-[9px] font-black uppercase tracking-widest text-cyan-400">Countries</span>
               </div>
               <div className="w-[1px] h-10 bg-white/10" />
               <div className="flex flex-col items-center">
                  <span className="text-xl font-black text-white">{leagues.length}</span>
                  <span className="text-[9px] font-black uppercase tracking-widest text-white/40">Competitions</span>
               </div>
               <div className="w-[1px] h-10 bg-white/10" />
               <div className="flex flex-col items-center">
                  <span className="text-xl font-black text-white">2024/25</span>
                  <span className="text-[9px] font-black uppercase tracking-widest text-white/40">Season</span>
               </div>
            </div>
         </div>
      </section>
